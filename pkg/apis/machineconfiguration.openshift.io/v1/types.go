...
// +kubebuilder:resource:scope=Cluster,singular=controllerconfig
...
// +genclient:nonNamespaced
// +k8s:deepcopy-gen:interfaces=k8s.io/apimachinery/pkg/runtime.Object
// +kubebuilder:resource:scope=Cluster,shortName=mc,singular=machineconfig
// +kubebuilder:subresource:status
...
// +genclient:nonNamespaced
// +k8s:deepcopy-gen:interfaces=k8s.io/apimachinery/pkg/runtime.Object
// +kubebuilder:resource:scope=Cluster,shortName=mcp,singular=machineconfigpool
// +kubebuilder:subresource:status
// +kubebuilder:printcolumn:JSONPath=.status.configuration.name,name=Config,type=string
// +kubebuilder:printcolumn:JSONPath=.status.conditions[?(@.type=="Updated")].status,name=Updated,type=string,description=When all the machines in the pool are updated to the correct machine config.
// +kubebuilder:printcolumn:JSONPath=.status.conditions[?(@.type=="Updating")].status,name=Updating,type=string,description=When at least one of machine is not either not updated or is in the process of updating to the desired machine config.
// +kubebuilder:printcolumn:JSONPath=.status.conditions[?(@.type=="Degraded")].status,name=Degraded,type=string,description="When progress is blocked on updating one or more nodes, or the pool configuration is failing."
// +kubebuilder:printcolumn:JSONPath=.status.machineCount,name=MachineCount,type=number,description=Total number of machines in the machine config pool
// +kubebuilder:printcolumn:JSONPath=.status.readyMachineCount,name=ReadyMachineCount,type=number,description=Total number of ready machines targeted by the pool
// +kubebuilder:printcolumn:JSONPath=.status.updatedMachineCount,name=UpdatedMachineCount,type=number,description=Total number of machines targeted by the pool that have the CurrentMachineConfig as their config
// +kubebuilder:printcolumn:JSONPath=.status.degradedMachineCount,name=DegradedMachineCount,type=number,description=Total number of machines marked degraded (or unreconcilable)
...
// +genclient:nonNamespaced
// +k8s:deepcopy-gen:interfaces=k8s.io/apimachinery/pkg/runtime.Object
// +kubebuilder:resource:scope=Cluster,singular=kubeletconfig
// +kubebuilder:subresource:status
...
// +genclient:nonNamespaced
// +k8s:deepcopy-gen:interfaces=k8s.io/apimachinery/pkg/runtime.Object
// +kubebuilder:resource:scope=Cluster,shortName=ctrcfg,singular=containerruntimeconfig
// +kubebuilder:subresource:status
