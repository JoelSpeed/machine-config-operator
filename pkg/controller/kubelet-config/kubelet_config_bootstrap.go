...
// nolint:gocyclo
func RunKubeletBootstrap(templateDir string, kubeletConfig *mcfgv1.KubeletConfig, controllerConfig *mcfgv1.ControllerConfig, mcpPools []*mcfgv1.MachineConfigPool) ([]*mcfgv1.MachineConfig, error) {
	var (
