...
// nolint:gocyclo
func RunKubeletBootstrap(templateDir string, kubeletConfigs []*mcfgv1.KubeletConfig, features *configv1.FeatureGate, controllerConfig *mcfgv1.ControllerConfig, mcpPools []*mcfgv1.MachineConfigPool) ([]*mcfgv1.MachineConfig, error) {
	var (
	...
	for _, kubeletConfig := range kubeletConfigs {
		...
		for _, pool := range mcpPools {
			...
			// Generate a bootstrap kubelet config
